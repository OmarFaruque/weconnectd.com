...
if (isset($_POST['submit'])) {
    ...
    $save_data_in_db = "INSERT INTO `promocode` (`promocode`, `discount`, `status`) VALUES ('$promocode', '$discount', '$status')";
  
      $result = $conn->query($save_data_in_db);
      if ($result === TRUE) {
        echo "<script>
        alert('Updated Successfully');
        location.href = 'add-promocode.php';
        </script>";
      } else {
        echo "<script>
            ...
            <div class="card card-primary">
              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10" style="display: flex; padding-top: 10px;">
                        ...
                        <div class="custom-control custom-radio">
                          <input class="custom-control-input" type="radio" id="customRadio2" value="Inactive" name="status">
                ...
                <div class="card-footer">
                  <button type="submit" name="submit" class="btn btn-info float-right">Add Promocode</button>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
