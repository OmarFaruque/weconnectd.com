...
<html>
    <head>
        ...
        <?php $blog = getInfoFromBulletin((int)$_GET['id'], $conn); ?>
    ...
    <body>
        <div class="container">
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $stmt = $conn->prepare("INSERT INTO `bulletincomments` (toid, comment, author) VALUES (?, ?, ?)");
            ...
            <div class="padding">
                <span id="padding10">
                    <small><a href="/">WeConnectd</a> / <a href="/bulletin/">Bulletin</a> / <a href="/bulletin/view.php?id=<?php echo $_GET['id']?>"><?php echo $blog['subject']; ?></a></small>
                </span><br>
                <div class="customtopLeft">  
                    ...
                    <div class="userInfoBlog">
                        ...
                        <ul class="blogsList">
                        <?php 
                            $stmt = $conn->prepare("SELECT * FROM bulletin WHERE author = ? ORDER BY id DESC");
