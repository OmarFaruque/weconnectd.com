...
if (isset($_POST['submit'])) {
    ...
    $save_data_in_db = "INSERT INTO `more_pages` (`name`, `text`, `add_on`, `status`, `icon`) VALUES ('$name', '$text', '$add_on', '$status', '$icon')";
    $result = $conn->query($save_data_in_db);

  if ($result === TRUE) {
    echo "<script>
        alert('Updated Successfully');
        location.href = 'add-morepages.php';
        </script>";
  } else {
        echo "<script>
            ...
            <div class="card card-primary">
              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control select2" style="width: 100%;" name="add_on" id="add_on">
                          ...
                          <option value="Footer Service">Footer-Service</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group row">
                ...
                <div class="card-footer">
                  <button type="submit" name="submit" class="btn btn-info float-right">Add Pages</button>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
