...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="padding">
                <span id="padding10">
                <small><a href="/">WeConnectd</a> / <a href="/users.php">Profiles</a> / <a href="/profile.php?id=<?php echo $_GET['id']?>"><?php echo $user['username']; ?></a> / <a href="/pm.php?id=<?php echo $_GET['id']?>">Send PM</a></small>
                </span><br>
                ...
                <div class="customtopRight">
                    <div class="comment">
						<?php if($msg_sent){ echo '<div class="msg_sent">'.$msg_sent.'</div>'; } ?>
