...
if (isset($_POST['submit'])) {
  ...
  $search = $_POST['search'];
      ...
      $save_data_in_db = "INSERT INTO `meta_tag` (`title`, `description`, `author`, `keywords`, `robots`, `canonical`, `page`, `page_row_id`, `search`) VALUES ('$title', '$description', '$author', '$keywords', '$robots', '$canonical', '$page', '$page_row_id', '$search')";
              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <textarea name="title" id="title" style="width:100%; height:100px;"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <textarea name="author" id="author" style="width:100%; height:100px;"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="text" class="col-sm-2 col-form-label">Keywords</label>
                    <div class="col-sm-10">
                      <textarea name="keywords" id="keywords" style="width:100%; height:100px;"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="text" class="col-sm-2 col-form-label">Robots</label>
                    <div class="col-sm-10">
                      <textarea name="robots" id="robots" style="width:100%; height:100px;"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="text" class="col-sm-2 col-form-label">Canonocal</label>
                    <div class="col-sm-10">
                      <textarea name="canonical" id="canonical" style="width:100%; height:100px;"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10" style="display: flex; padding-top: 10px;">
                        <div class="custom-control custom-radio mr-5">
                          <input class="custom-control-input" type="radio" id="customRadio1" name="search" value="1" checked>
                          <label for="customRadio1" class="custom-control-label">Yes</label>
                        </div>
                        <div class="custom-control custom-radio">
                          <input class="custom-control-input" type="radio" id="customRadio2" value="0" name="search">
                ...
                <div class="card-footer">
                  <button type="submit" name="submit" class="btn btn-info float-right">Add Meta Tag</button>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
