...
<div class="container">		
	...
	<br>		
	<?php if(isset($_SESSION['siteusername']) && $_SESSION['siteusername']) { ?> 	
		<div class="chat">	
			<div id="frame">		
				<div id="sidepanel">
					<div id="profile">
					...
					include ('Chat.php');
					$chat = new Chat();
					$loggedUser = $chat->getUserDetails($_SESSION['siteusername']);
					echo '<div class="wrap">';
					$currentSession = '';
					...
					<?php
					echo '<ul>';
					$chatUsers = $chat->chatUsers($_SESSION['siteusername']);
