...
if(isset($_GET['coin_id'])){
    ...
    $edit = $conn->query("SELECT * FROM sc_top_40 WHERE id='$coin_id'");
    if($edit->num_rows == 1){
...
if (isset($_POST['submit'])) {
  ...
  if(!empty($imagename)){
    ...
    $save_data_in_db = "UPDATE `sc_top_40` SET `name`='$name', `website`='$website', `icon`='$imagename', `ticker`='$market' WHERE id='$coin_id'";
  } else{
    $save_data_in_db = "UPDATE `sc_top_40` SET `name`='$name', `website`='$website', `ticker`='$market' WHERE id='$coin_id'";
  }
    ...
    if ($result === TRUE) {
      ...
      location.href = 'edit-sc-top-40.php?coin_id=$coin_id';
      </script>";
    } else {
      echo "<script>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manage SC Top 40</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Manage SC Top 40</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update SC Top 40</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group row">
					...
					<div class="form-group row">
                    <label for="title" class="col-sm-2 col-form-label">Ticker</label> 
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="market" name="market" value="<?php echo $edit_d['ticker']; ?>" required>
                    </div>
				  </div>
                  <div class="form-group row">
                ...
                <div class="card-footer">
                  <button type="submit" name="submit" class="btn btn-info float-right">Upadte</button>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
