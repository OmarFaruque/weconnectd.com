    ...
    <head>
        ...
        <?php 
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['fileup']) {
                ...
                if($songFileType != "tff" && $songFileType != "torrent" && $songFileType != "mov" && $songFileType != "rtf" && $songFileType != "mp3" && $songFileType != "doc" && $songFileType != "mp4" && $songFileType != "png" && $songFileType != "gif" && $songFileType != "jpg" && $songFileType != "jpeg" && $songFileType != "wav" && $songFileType != "mp3" && $songFileType != "svg") {
                    $fileerror = 'unsupported file type. must be tiff, mp4, png, gif, mov, torrent, jpg, jpeg, wav, rtf, doc, mp3, or svg<hr>';
                    $uploadOk = false;
                }
        ...
        <div class="container">
            ...
            <div class="padding">
                <span style="padding-left: 20px;">
                    <h1 id="noMargin">&nbsp;CRUMB Snatcher</h1>
                </span>
                ...
                <div class="customtopRight">
                    ...
                    <b>Uploaded Files</b> <small>[<?php if(!empty($total)) { echo FileSizeConvert($total); } else { echo "0B";} ?>/20MB]</small><br>
                    <ul>
                    <?php 
