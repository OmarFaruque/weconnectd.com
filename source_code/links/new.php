...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="padding">
                <span id="padding10">
                    <small>Weconnectd / Links / New</small>
                </span><br>
                ...
                <div class="customtopRight">
                    <div class="comment">
                        <form method="post" enctype="multipart/form-data" id="submitform">
                            ...
                            <br><input placeholder="Group Title" type="text" name="subject" required="required" size="63"><br>
                            ...
                            <input type="submit" value="Post" class="g-recaptcha" data-callback="onLogin">
                        </form>
                    </div>
                </div>
            </div>
