...
if (isset($_POST['submit'])) {
    ...
    if (empty($name)) {
        ...
        header("Location: add-admin.php?error=$password1_error");
        ...
        if ($password1 != $password2) {
          ...
          if ($conn->query($sqluser) === True) {
            ...
            $sql = "INSERT INTO `admin` (`name`, `email`, `photo`, `permission`, `password`)
            VALUES ('$name', '$email', '$photo', '$permission', '$hash_password')";
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      <div class="custom-control custom-checkbox">
                        <input class="custom-control-input custom-control-input-danger custom-control-input-outline" type="checkbox" value="<?php echo $ser_d[0]; ?>" name="permission[]" id="customCheckbox<?php echo $i; ?>">
