            ...
            <div class="padding">
                <div class="customtopLeft">  
                    <div class="sideblog">
                        <h3>My Controls</h3>
                        <ul>
                            <li><a href="" class="man">Bulletin Home</a></li>
                    ...
                    <div class="sideblog">
                        ...
                        <ul>
                            <?php
                                $blogTop = array();
                                $stmt = $conn->prepare("SELECT * FROM bulletin");
                                $stmt->execute();
                ...
                <div class="customtopRight">  
                    <div class="splashBlue">
                        This doesn't really look that good... I'll try to make it look better later. <br><br><a href="new.php"><button>New Bulletin</button></a>
                    </div><br>
                    ...
                    <div class="login">
                        ...
                        <div class="padding">
                            <?php
                                $total_pages = $conn->query('SELECT COUNT(*) FROM bulletin WHERE visiblity = "Visible"')->fetch_row()[0]; 
                                $page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
                                $num_results_on_page = 16;

                                $stmt = $conn->prepare("SELECT * FROM bulletin WHERE visiblity = 'Visible' ORDER BY id DESC LIMIT ?,?");
