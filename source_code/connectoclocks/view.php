...
<html>
    <head>
        ...
        <?php $blog = getInfoFromVlog((int)$_GET['id'], $conn); ?>
        ...
        <div class="container">
            ...
            <div class="padding">
                ...
                <div class="customtopRight">
                    <div class="blogCont">
                        <a href="view.php?id=<?php echo $blog['id']; ?>"><h1 id="noMargin"><?php echo $blog['title']; ?></h1></a>
                        <video width="450"
                       height="250"
                       controls
                       preload="auto">
                    <source src=
"https://weconnectd.com/uploads/videos/<?php echo $blog['filename']; ?>"
                       type="video/mp4">
                </video>
                    </div><br>
                    <div class="comment">
