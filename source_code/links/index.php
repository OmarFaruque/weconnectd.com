...
<html>
    <head>
        ...
        <link rel="stylesheet" href="https://weconnectd.com/static/css/table2.css"> 
        <style>
            .customtopLeft {
                float: left;
                width: calc( 22% - 20px );
        ...
        <div class="container">
            ...
            <div class="padding">
                <div class="customtopLeft">  
                    <b><small>
                        <div class="groupssidelinks">
                            <ul>
                                <li><a href="">WeLinks Home</a></li>
                                <li><a href="/edit/">My WeLink</a></li>
                                <li><a href="new.php">Create WeLink</a></li>
                                <li class="last"><a href="">Search WeLinks</a></li>
                            </ul>
                        </div>
                    </small></b>
                </div>
                ...
                <div class="customtopRight">  
                    <h1 id="noMargin">WeLinks Home</h1>Sort by:: <b>Newest</b><br>
                    <small><a href="/">Weconnectd</a> / <a href="/groups/">WeLinks</a></small><br><br>
                    <table>
                        <tr>
                            <th>Icon</th>
                            <th>Info</th>
						...
						?>
						Total Groups: <?php echo $total_pages; ?>
                        ...
                        <center>
                            ...
                            <?php if ($page+1 < ceil($total_pages / $num_results_on_page)+1): ?><a href="index.php?page=<?php echo $page+1 ?>"><?php echo $page+1 ?></a><?php endif; ?>
                            <?php if ($page+2 < ceil($total_pages / $num_results_on_page)+1): ?><a href="index.php?page=<?php echo $page+2 ?>"><?php echo $page+2 ?></a><?php endif; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span id="floatRight" style="text-align:right;">
                                        ...
                                        <?php
                                            $stmt = $conn->prepare("SELECT * FROM `join_group` WHERE `groups` = ?");
                                    ...
                                    <?php if(isset($_SESSION['siteusername'])){ ?><a href="view.php?id=<?php echo $row['id']; ?>"><button>More Info</button></a><?php } ?> 
                                </td>
