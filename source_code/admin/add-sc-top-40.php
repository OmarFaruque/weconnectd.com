...
if (isset($_POST['submit'])) {
    ...
    $save_data_in_db = "INSERT INTO `sc_top_40` (`name`, `website`, `icon`, `ticker`) VALUES ('$name', '$website', '$imagename', '$market')";
  
      $result = $conn->query($save_data_in_db);
      if ($result === TRUE) {
        echo "<script>
        alert('Updated Successfully');
        location.href = 'add-sc-top-40.php';
        </script>";
      } else {
        echo "<script>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manage SC Top 4</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Add SC Top 40</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add SC Top 40</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
