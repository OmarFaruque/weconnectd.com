            ...
            <div class="padding">
                <div class="customtopLeft">  
                    <div class="sideblog">
                        <h3>My Controls</h3>
                        <ul>
                            <li><a href="" class="man">ConnectO'Clock Home</a></li>
                ...
                <div class="customtopRight">  
                    <div class="splashBlue">
                        This doesn't really look that good... I'll try to make it look better later. <br><br><a href="new.php"><button>New ConnectO'Clock Post</button></a>
                    </div><br>
                    
                    <div class="login">
                        <div class="loginTopbar">
                            <b>All ConnectO'Clocks</b>
                        </div>
                        <div class="padding">
                            <?php
                                $total_pages = $conn->query('SELECT COUNT(*) FROM videos')->fetch_row()[0]; 
                                $page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
                                $num_results_on_page = 16;

                                $stmt = $conn->prepare("SELECT * FROM videos ORDER BY id DESC LIMIT ?,?");
...
<video width="450"
                       ...
                       preload="auto">
                    <source src=
"https://weconnectd.com/uploads/videos/<?php echo $row['filename']; ?>"
                       type="video/mp4">
                </video>
										</div>
                                        <?php echo htmlspecialchars($row['title']); ?> from <b><?php echo htmlspecialchars($row['author']); ?></b></a><br>
                                        <small>
