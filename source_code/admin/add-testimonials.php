...
if (isset($_POST['submit'])) {
  ...
  $image_in = array('jpg', 'png', 'jpeg');
      ...
      $save_data_in_db = "INSERT INTO `testimonials` (`name`, `company`, `designation`, `text`, `image`) VALUES ('$name', '$company', '$designation', '$text', '$imagename')";
  
      $result = $conn->query($save_data_in_db);
      if ($result === TRUE) {
        echo "<script>
        alert('Updated Successfully');
        location.href = 'add-testimonials.php';
        </script>";
      } else {
        echo "<script>
            ...
            <div class="card card-primary">
              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="card-footer">
                  <button type="submit" name="submit" class="btn btn-info float-right">Add Testimonial</button>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
