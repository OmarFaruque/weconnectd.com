...
if (isset($_POST['submit'])) {
  ...
  $save_data_in_db = "INSERT INTO `recent_result` (`name`, `photo`, `info`) VALUES ('$name', '$imagename', '$info')";
  
  $result = $conn->query($save_data_in_db);
  if ($result === TRUE) {
        echo "<script>
        alert('Updated Successfully');
        location.href = 'add-recent-result.php';
        </script>";
  } else {
        echo "<script>
...
<head>
  ...
  <title>Add Recent Results</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Recent Results</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Recent Results</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
