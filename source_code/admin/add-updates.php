...
if (isset($_POST['submit'])) {
    ...
    $save_data_in_db = "INSERT INTO `updates` (`updates`, `file`, `status`) VALUES ('$updates', '$filename', '$status')";
    $result = $conn->query($save_data_in_db);

  if ($result === TRUE) {
    echo "<script>
        alert('Updated Successfully');
        location.href = 'add-updates.php';
        </script>";
  } else {
        echo "<script>
              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" id="text" name="updates" required></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                ...
                <div class="card-footer">
                  <button type="submit" name="submit" class="btn btn-info float-right">Add Updates</button>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
