            ...
            <br>
                    ...
                    <center>
                        <form method="get" action="/browse.php">
                            <select name="searchmethod">
                                ...
                                <option value="groups">WeLink</option>
								<option value="files">CRUMB</option>
                ...
                <div class="login">
                    ...
                    <?php } ?>
                        ...
                        <?php if($type == "users") { ?>
                            <div class="item1"><a href="profile.php?id=<?php echo getIDFromUser($row['username'], $conn); ?>"><div><b><center><?php echo $row['username']; ?></center></b></div><img src="<?php echo ROOT_URL; ?>/dynamic/pfp/<?php echo getPFPFromUser($row['username'], $conn); ?>"></a></div>
