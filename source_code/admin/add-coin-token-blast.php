...
if (isset($_POST['submit'])) {
    ...
    $save_data_in_db = "INSERT INTO `coin_token_blast` (`name`, `website`, `icon`, `market`) VALUES ('$name', '$website', '$imagename', '$market')";
  
      $result = $conn->query($save_data_in_db);
      if ($result === TRUE) {
        echo "<script>
        alert('Updated Successfully');
        location.href = 'add-coin-token-blast.php';
        </script>";
      } else {
        echo "<script>
...
<head>
  ...
  <title>Add Coin Token Blast</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Coin Token Blast</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Coin Token Blast</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
