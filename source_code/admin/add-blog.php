...
if (isset($_POST['submit'])) {
  ...
  $image_in = array('jpg', 'png', 'jpeg');
    ...
    if(in_array($for_image,$image_in)) {
      ...
      $save_data_in_db = "INSERT INTO `blog` (`title`, `text`, `brief`, `image`, `author`, `date`, `status`) VALUES ('$title', '$text', '$brief', '$imagename', '$author', '$date', '$status')";
  
      $result = $conn->query($save_data_in_db);
      if ($result === TRUE) {
        echo "<script>
        alert('Added Successfully');
        location.href = 'add-blog.php';
        </script>";
      } else {
        echo "<script>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10" style="display: flex; padding-top: 10px;">
                        ...
                        <div class="custom-control custom-radio">
                          <input class="custom-control-input" type="radio" id="customRadio2" value="Deactive" name="status">
